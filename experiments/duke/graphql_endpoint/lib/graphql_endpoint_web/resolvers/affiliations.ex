defmodule GraphqlEndpointWeb.Resolvers.Affiliations do
  ...
  defp fetch_by_person_id(id) do
    ...
    case Search.fetch("affiliations", ["affiliation"], q) do
  ...
  defp process_body(%{"hits" => _h = %{"hits" => hits}}) do
    Enum.map(hits, &process_affliliation/1)
  end
  ...
  defp process_affliliation(es_object) do
    es_object
    |> Map.get("_source")
